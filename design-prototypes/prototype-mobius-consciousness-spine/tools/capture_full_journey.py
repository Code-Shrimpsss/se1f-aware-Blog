...
CONTINUITY_SPECS: Sequence[Tuple[float, str]] = (
    ...
    (2.78, "thought-node-contact"),
    (2.92, "thought-node-deposition"),
    (3.00, "thought-node-absorbed"),
    (3.45, "fold-off-axis-open-side"),
    (4.00, "absorbed-node-enters-relation"),
    (4.45, "three-source-surfaces-rise"),
    (5.85, "three-nodes-remain-distinct"),
    (6.35, "shared-curvature-forming"),
    (6.85, "viewpoint-generated-in-negative-space"),
    ...
    (9.50, "room-experience-enters-judgment"),
    (10.05, "room-2026-apparent-whole"),
    (10.85, "room-sees-how-judgment-formed"),
    (11.00, "room-remembers-passage"),
    (11.45, "reflection-exit-keeps-surface-visible"),
    (12.00, "no-black-flash-between-acts"),
    (12.45, "viewpoint-begins-integration"),
    (12.78, "integration-spreads-along-surface"),
...
DIRECTOR_SPECS: Sequence[Tuple[float, str]] = (
    ...
    (3.00, "observation-node-absorbed"),
    (4.55, "same-node-enters-three-surface-relation"),
    (6.85, "new-viewpoint-generated-by-negative-space"),
    (8.55, "single-time-synchronization"),
    (9.95, "reflection-one-room-many-times"),
    (10.85, "system-sees-why-judgment-formed"),
    (12.78, "viewpoint-fuses-into-mobius-system"),
    (13.00, "nature-whole-revealed-as-updated"),
)
